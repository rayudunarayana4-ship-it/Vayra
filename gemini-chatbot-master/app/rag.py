...
except ImportError:  # pragma: no cover - supports local retrieval-only mode
    Groq = None
...
_client = Groq(api_key=settings.groq_api_key) if settings.groq_api_key and Groq else None
